...
The following code snippet shows how the HttpClient is registered in the Dependency Injection (DI) container.
...
And this is how the Polly Strategy is created:
